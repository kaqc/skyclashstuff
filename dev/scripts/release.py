...
if __name__ == '__main__':
    ...
    # Copy dev dir
    if os.path.exists(Path(upgrade_temp, 'dev')):
        shutil.rmtree(Path(upgrade_temp, 'dev'))

    shutil.copytree('dev', Path(upgrade_temp, 'dev'))
    shutil.copyfile('core/classes/Misc/IntegrityChecker.php', Path(upgrade_temp, 'core/classes/Misc/IntegrityChecker.php'))
